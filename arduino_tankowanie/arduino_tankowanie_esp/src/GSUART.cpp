...
void MsgTenso::deserialize(const Byte* bytes_in, const size_t size_in) {
  ...
  memcpy(&tenso_left_raw, bytes_in, sizeof(tenso_left_raw));
  memcpy(&tenso_right_raw, bytes_in + sizeof(tenso_left_raw), sizeof(tenso_right_raw));
}
...
void MsgTemperature::deserialize(const Byte* bytes_in, const size_t size_in) {
  ...
  memcpy(&temperature_celsius, bytes_in, sizeof(temperature_celsius));
}
...
void MsgPressure::deserialize(const Byte* bytes_in, const size_t size_in) {
  if (bytes_in == nullptr || size_in < sizeof(float)) return;
  memcpy(&pressure_bar, bytes_in, sizeof(pressure_bar));
}
...
void MsgUartStats::deserialize(const Byte* bytes_in, const size_t size_in) {
  ...
  memcpy(&stats, bytes_in, UARTStatistics::Stats::_STRUCT_SIZE);
}
...
void MsgAbort::deserialize(const Byte* bytes_in, const size_t size_in) {
  ...
  memcpy(&abort, bytes_in, sizeof(abort));
}
